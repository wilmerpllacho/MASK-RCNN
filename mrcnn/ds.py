...
def compute_backbone_shapes(config, image_shape):
    ...
    assert config.BACKBONE in ["resnet50", "resnet101","resnet18"]
    return np.array(
...
def resnet_graph18(input_image, architecture, stage5=False, train_bn=True):
...
def resnet_graph(input_image, architecture, stage5=False, train_bn=True):
    ...
    if architecture == "resnet18":
        return resnet_graph18(input_image, architecture, stage5, train_bn)
